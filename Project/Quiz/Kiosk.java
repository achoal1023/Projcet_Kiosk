...
class Kiosk1 extends JFrame implements ActionListener{
   ...
   void setPanel(){
     ...
     tb2 = new JTable(model2);
      ...
      //pCL
      menuList6 = new JButton[9];
      for(int i = 0; i < menuList6.length; i++){
      menuList6[0]  = new JButton("1");
      menuList6[1]  = new JButton("2");
      menuList6[2]  = new JButton("3");
      menuList6[3]  = new JButton("4");
      menuList6[4]  = new JButton("5");
      menuList6[5]  = new JButton("6");
      menuList6[6]  = new JButton("7");
      menuList6[7]  = new JButton("8");
      menuList6[8]  = new JButton("9");
      }
      for(int i = 0; i < menuList3.length; i++){
         pC6.add(menuList6[i]);
      }
      menuList7 = new JButton[9];
      for(int i = 0; i < menuList7.length; i++){
      menuList7[0]  = new JButton("11");
      menuList7[1]  = new JButton("22");
      menuList7[2]  = new JButton("33");
      menuList7[3]  = new JButton("44");
      menuList7[4]  = new JButton("55");
      menuList7[5]  = new JButton("66");
      menuList7[6]  = new JButton("77");
      menuList7[7]  = new JButton("88");
      menuList7[8]  = new JButton("99");
      }
      for(int i = 0; i < menuList3.length; i++){
         pC7.add(menuList7[i]);
      }
      ...
      tL.setPreferredSize(new Dimension(30, 60));
      tR.setPreferredSize(new Dimension(30, 60));
      ...
      // SOUTH 영역
      cal.setBackground(new Color(50, 100, 100));
      cal.setForeground(Color.white);
      cal.setOpaque(true);
      cal.setFont(new Font("Arial", Font.BOLD, 20));
      cal.setBounds(0,0,100,0);
     ...
     menuList6[0].addActionListener(this); menuList6[1].addActionListener(this); menuList6[2].addActionListener(this); menuList6[3].addActionListener(this); menuList6[4].addActionListener(this); menuList6[5].addActionListener(this); menuList6[6].addActionListener(this); menuList6[7].addActionListener(this); menuList6[8].addActionListener(this);
     menuList7[0].addActionListener(this); menuList7[1].addActionListener(this); menuList7[2].addActionListener(this); menuList7[3].addActionListener(this); menuList7[4].addActionListener(this); menuList7[5].addActionListener(this); menuList7[6].addActionListener(this); menuList7[7].addActionListener(this); menuList7[8].addActionListener(this); 
   }
   ...
   public void actionPerformed(ActionEvent e){
     ...
     else if(obj == menuList6[0]){
        addRow(idx, 100000, inputMenu, add);
      }
     else if(obj == menuList6[1]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList6[2]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList6[3]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList6[4]){
        addRow(idx, 100000, inputMenu, add);
      }          
     else if(obj == menuList6[5]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList6[6]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList6[7]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList6[8]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList7[0]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList7[1]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList7[2]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList7[3]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList7[4]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList7[5]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList7[6]){
        addRow(idx, 100000, inputMenu, add);
      }     
     else if(obj == menuList7[7]){
        addRow(idx, 100000, inputMenu, add);
      }          
     else if(obj == menuList7[8]){
        addRow(idx, 100000, inputMenu, add);
      }      
   }
